    ...
    if(success)
    {
        return (
            <main className="flex flex-col py-24 h-1/2 items-center justify-center text-center gap-6 animate-pulse">
                    ...
                    <svg aria-hidden="true" class="w-8 h-8 mr-2 text-gray-400 animate-spin dark:text-gray-600 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
